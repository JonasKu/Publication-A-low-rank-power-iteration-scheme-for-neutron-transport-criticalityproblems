...
#keff = 7.265133840194547554e-01 # plutonium_mix_02, G = 618, I = 100
#keff = 9.992933452674491734e-01; # light_water_reactor, G = 361, I = 400
keff = 9.999061311274380914e-01; # light_water_reactor, G = 361, I = 400
...
plt.xlim([0,maxIt])
x, labels = plt.xticks()
xint = range(int(x[0]), int(x[-1])+1,15)
plt.xticks(xint)      
plt.grid(True)      
