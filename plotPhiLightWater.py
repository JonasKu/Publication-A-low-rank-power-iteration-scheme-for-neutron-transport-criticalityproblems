...
for nG in G:
    ...
    for nX in NCells:
        ...
        for r in ranks:
            ...
            plt.savefig(f"{problem}/phiGroupsMaterial{problem}G{nG}NCells{nX}Rank{r}.png", bbox_inches='tight')
            ...
            plt.tick_params(axis='both', labelsize=20)
            plt.legend(fontsize=20)
            plt.savefig(f"{problem}/phiInEnergyAtX{x[idxPlot1]}Material{problem}G{nG}NCells{nX}Rank{r}.png", bbox_inches='tight')
            ...
            plt.tick_params(axis='both', labelsize=20)
            plt.legend(fontsize=20)
            plt.savefig(f"{problem}/phiNoNormalizationInEnergyAtX{x[idxPlot1]}Material{problem}G{nG}NCells{nX}Rank{r}.png", bbox_inches='tight')
